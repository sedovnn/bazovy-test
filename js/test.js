  ...
  function demoMap() {
    ...
    var skills = [
      ...
      row('alt', 'Генерация альтернатив', 4, 4, 'ГА-1', 2,
          'Гейт L2 пройден: добавлен новый элемент. L3 нет: другой стратегической альтернативы не предложено.'),
      row('prio', 'Приоритизация', 3, 4, 'ПР-1', 4,
          'Гейт L4 пройден: отказ сформулирован как правило. L5 нет: высвобожденный ресурс не назван.'),
      row('future', 'Картина будущего', 4, 4, 'МК-1', 3,
          'Гейт L3 пройден: названо новое положение на рынке с горизонтом. L4 нет: смены модели не видно.'),
      row('path', 'Путь к цели', 1, 4, 'ПП-1', 2,
          'Гейт L2 пройден: одно действие привязано к цели. L3 нет: этапы не выстроены от цели.')
    ];
